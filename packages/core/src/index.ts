...
export interface DecisionAudit { id: string; marketId: string; tenantId: string; scannerData: NormalizedMarket; dossierSummary?: Partial<MarketDossier>; modelEstimates: ModelEstimate[]; ensembleOutput?: EnsembleResult; edgeCalculations?: Record<string, number>; riskDecision?: RiskDecision; opportunityScore?: number; finalOutcome: 'trade' | 'skip'; calibrationBackfill?: Partial<CalibrationRecord>; createdAt: Date; }
